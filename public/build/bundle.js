    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 34, 14, 1499);
    			add_location(div1, file, 35, 14, 1533);
    			add_location(div2, file, 36, 14, 1567);
    			attr_dev(div3, "class", "text-center font-thin text-white text-6xl leading-tight\r\n              tracking-widest mb-8");
    			add_location(div3, file, 31, 12, 1363);
    			add_location(div4, file, 39, 14, 1700);
    			add_location(div5, file, 40, 14, 1763);
    			attr_dev(div6, "class", "text-white text-center text-xl font-hairline mb-4");
    			add_location(div6, file, 38, 12, 1621);
    			attr_dev(div7, "class", "text-white text-center text-xl font-hairline w-full\r\n              md:w-3/5");
    			add_location(div7, file, 42, 12, 1843);
    			attr_dev(hr, "class", "my-8 w-1/3");
    			add_location(hr, file, 48, 12, 2109);
    			...
    			add_location(path0, file, 56, 18, 2503);
    			...
    			add_location(g2, file, 99, 20, 5689);
    			...
    			add_location(g3, file, 90, 18, 5330);
    			...
    			add_location(g6, file, 153, 20, 8569);
    			...
    			add_location(g7, file, 146, 18, 8301);
    			...
    			add_location(svg2, file, 138, 16, 7945);
    			attr_dev(a2, "href", "https://twitter.com/VinnyPassanisi");
    			add_location(a2, file, 137, 14, 7882);
    			attr_dev(div8, "class", "flex flex-row");
    			add_location(div8, file, 49, 12, 2148);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 54, 4, 1582);
    			attr_dev(p, "class", "font-bold");
    			add_location(p, file$1, 62, 8, 1979);
    			attr_dev(div1, "class", "flex flex-wrap bg-gray-400 rounded-md p-1");
    			add_location(div1, file$1, 63, 8, 2025);
    			attr_dev(div2, "class", "mt-4");
    			add_location(div2, file$1, 61, 6, 1951);
    			attr_dev(img, "class", "h-8 w-8 ");
    			if (img.src !== (img_src_value = /*project*/ ctx[0].overlayIcon)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$1, 72, 8, 2361);
    			attr_dev(div3, "class", "absolute top-0 right-0 p-2");
    			add_location(div3, file$1, 71, 6, 2311);
    			attr_dev(a, "href", a_href_value = /*project*/ ctx[0].url);
    			attr_dev(a, "class", "absolute bottom-0 right-0 flex items-center justify-center\r\n        bg-gray-900 text-white w-full block h-16 hover:bg-gray-800 transition\r\n        duration-500 ease-in-out");
    			add_location(a, file$1, 74, 6, 2440);
    			attr_dev(div4, "class", "absolute bg-white w-full h-full top-0 bottom-0 left-0 right-0 p-2");
    			add_location(div4, file$1, 58, 4, 1773);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$1, 65, 12, 2142);
    		},
    		m: function mount(target, anchor) {
