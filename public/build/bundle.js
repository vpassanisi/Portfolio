...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 34, 14, 1518);
    			add_location(div1, file, 35, 14, 1552);
    			add_location(div2, file, 36, 14, 1586);
    			attr_dev(div3, "class", "text-center font-thin text-white text-5xl sm:text-6xl\r\n              leading-tight tracking-widest mb-8");
    			add_location(div3, file, 31, 12, 1370);
    			add_location(div4, file, 39, 14, 1719);
    			add_location(div5, file, 40, 14, 1782);
    			attr_dev(div6, "class", "text-white text-center text-xl font-hairline mb-4");
    			add_location(div6, file, 38, 12, 1640);
    			attr_dev(div7, "class", "text-white text-center text-xl font-hairline w-full\r\n              md:w-3/5");
    			add_location(div7, file, 42, 12, 1862);
    			...
    			add_location(path3, file, 219, 18, 12594);
    			...
    			add_location(path4, file, 225, 18, 12879);
    			...
    			add_location(div9, file, 28, 10, 1224);
    			...
    			add_location(path5, file, 249, 14, 14790);
    			attr_dev(svg4, "class", "transform rotate-90 fill-current text-white h-8 w-8");
    			attr_dev(svg4, "viewBox", "0 0 20 20");
    			add_location(svg4, file, 246, 12, 14659);
    			attr_dev(div10, "class", "absolute bottom-0 text-white");
    			add_location(div10, file, 245, 10, 14603);
    			attr_dev(div11, "class", "relative bg-black-alpha-40 flex flex-col items-center\r\n          justify-center w-full h-full");
    			add_location(div11, file, 24, 8, 1022);
    			attr_dev(div12, "class", "w-full h-full");
    			add_location(div12, file, 21, 6, 905);
    			attr_dev(div13, "class", "background w-full h-full svelte-1kanj3e");
    			add_location(div13, file, 20, 4, 831);
    		},
    ...
    /* src\Snippets.svelte generated by Svelte v3.20.0 */
    const file$3 = "src\\Snippets.svelte";
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$3, 17, 10, 588);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			append_dev(a, t0);
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$3, 31, 10, 1059);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			append_dev(a, t0);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 5, 2, 112);
    			attr_dev(div1, "class", "text-white text-4xl font-hairline");
    			add_location(div1, file$3, 14, 6, 437);
    			attr_dev(div2, "class", "mb-8");
    			add_location(div2, file$3, 15, 6, 508);
    			attr_dev(div3, "class", "text-white text-4xl font-hairline");
    			add_location(div3, file$3, 28, 6, 933);
    			add_location(div4, file$3, 29, 6, 1000);
    			attr_dev(div5, "class", "flex flex-col max-w-screen-xl border p-4 w-full h-full mb-8");
    			add_location(div5, file$3, 12, 4, 354);
    			attr_dev(div6, "class", "flex justify-center");
    			add_location(div6, file$3, 11, 2, 315);
    			add_location(section, file$3, 4, 0, 99);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$4, 8, 0, 216);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Tailwindcss, Landing, Projects, Snippets });
    	return [];
    }
