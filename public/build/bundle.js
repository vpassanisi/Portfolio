...
var app = (function () {
    ...
    /* src\sections\Landing.svelte generated by Svelte v3.20.0 */
    const file = "src\\sections\\Landing.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t9 = space();
    			div7 = element("div");
    			div7.textContent = "Interested in Web Development, Programming, Music, Space, and\r\n              Learning.";
    			t11 = space();
    			hr = element("hr");
    			t12 = space();
    			div8 = element("div");
    			...
    			t16 = text(".st0 {\n  fill: none;\n  stroke: #fff;\n  stroke-width: 8;\n  stroke-linecap: round;\n  stroke-linejoin: round;\n  stroke-miterlimit: 10;\n}\r\n                  \r\n/*# sourceMappingURL=data:application/json;base64, */");
    			...
    			add_location(div0, file, 34, 14, 1542);
    			add_location(div1, file, 35, 14, 1576);
    			add_location(div2, file, 36, 14, 1610);
    			attr_dev(div3, "class", "text-center font-thin text-white text-5xl sm:text-6xl\r\n              leading-tight tracking-widest mb-8");
    			add_location(div3, file, 31, 12, 1394);
    			add_location(div4, file, 39, 14, 1743);
    			add_location(div5, file, 40, 14, 1806);
    			attr_dev(div6, "class", "text-white text-center text-xl font-hairline mb-4");
    			add_location(div6, file, 38, 12, 1664);
    			attr_dev(div7, "class", "text-white text-center text-xl font-hairline w-full\r\n              md:w-3/5");
    			add_location(div7, file, 42, 12, 1886);
    			attr_dev(hr, "class", "my-8 w-1/3");
    			add_location(hr, file, 48, 12, 2126);
    			...
    			add_location(path0, file, 56, 18, 2520);
    			...
    			add_location(g2, file, 99, 20, 5706);
    			...
    			add_location(g3, file, 90, 18, 5347);
    			...
    			add_location(g6, file, 153, 20, 8591);
    			...
    			add_location(g7, file, 146, 18, 8323);
    			...
    			add_location(svg2, file, 138, 16, 7962);
    			attr_dev(a2, "href", "https://twitter.com/VinnyPassanisi");
    			add_location(a2, file, 137, 14, 7899);
    			attr_dev(style, "type", "text/css");
    			add_location(style, file, 209, 18, 11615);
    			...
    			add_location(path3, file, 219, 18, 12618);
    			...
    			add_location(path4, file, 225, 18, 12903);
    			...
    			add_location(svg3, file, 196, 16, 11108);
    			attr_dev(a3, "href", "https://github.com/vpassanisi?tab=repositories");
    			add_location(a3, file, 195, 14, 11033);
    			attr_dev(div8, "class", "flex flex-row");
    			add_location(div8, file, 49, 12, 2165);
    			attr_dev(div9, "class", "bg-black-alpha-70 border w-90p max-w-screen-sm flex flex-col\r\n            items-center justify-center p-4");
    			add_location(div9, file, 28, 10, 1248);
    			attr_dev(path5, "d", "M14.989,9.491L6.071,0.537C5.78,0.246,5.308,0.244,5.017,0.535c-0.294,0.29-0.294,0.763-0.003,1.054l8.394,8.428L5.014,18.41c-0.291,0.291-0.291,0.763,0,1.054c0.146,0.146,0.335,0.218,0.527,0.218c0.19,0,0.382-0.073,0.527-0.218l8.918-8.919C15.277,10.254,15.277,9.784,14.989,9.491z");
    			add_location(path5, file, 249, 14, 14814);
    			attr_dev(svg4, "class", "transform rotate-90 fill-current text-white h-8 w-8");
    			attr_dev(svg4, "viewBox", "0 0 20 20");
    			add_location(svg4, file, 246, 12, 14683);
    			attr_dev(div10, "class", "absolute bottom-0 text-white");
    			add_location(div10, file, 245, 10, 14627);
    			attr_dev(div11, "class", "relative bg-black-alpha-40 flex flex-col items-center\r\n          justify-center w-full h-full");
    			add_location(div11, file, 24, 8, 1046);
    			attr_dev(div12, "class", "w-full h-full");
    			add_location(div12, file, 21, 6, 929);
    			attr_dev(div13, "class", "background w-full h-full svelte-kfiho5");
    			add_location(div13, file, 20, 4, 855);
    		},
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				if (!div12_transition) div12_transition = create_bidirectional_transition(div12, scale, { delay: 200, duration: 2000, start: 1.2 }, true);
    				div12_transition.run(1);
    			});

    			if (!div13_intro) {
    				add_render_callback(() => {
    					div13_intro = create_in_transition(div13, fade, { duration: 300 });
    					div13_intro.start();
    				});
    			}
    		...
    		o: function outro(local) {
    			if (!div12_transition) div12_transition = create_bidirectional_transition(div12, scale, { delay: 200, duration: 2000, start: 1.2 }, false);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file, 18, 0, 777);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\components\ProjectCard.svelte generated by Svelte v3.20.0 */
    const file$1 = "src\\components\\ProjectCard.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file$1, 87, 8, 3134);
    			attr_dev(img1, "class", "h-12 w-12");
    			if (img1.src !== (img1_src_value = "./icons/github-icon.svg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "");
    			add_location(img1, file$1, 97, 10, 3557);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$1, 75, 12, 2695);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*project*/ 1 && t0_value !== (t0_value = /*tech*/ ctx[7].name + "")) set_data_dev(t0, t0_value);
    ...
    /* src\sections\Projects.svelte generated by Svelte v3.20.0 */
    const file$2 = "src\\sections\\Projects.svelte";
    ...
    const goSnippets = [
      {
        title: "FizzBuzz",
        link: "https://play.golang.org/p/KYPTQEnXRaq",
      },
      {
        title: "Reverse a string",
        link: "https://play.golang.org/p/lyER0B3SQyG",
      },
    ];

    const javascriptSnippets = [
      {
        title: "reverse a string (React)",
        link: "https://codesandbox.io/s/reverse-a-string-mwddw",
      },
      {
        title: "React and Tailwindcss Responsive Navbar",
        link: "https://codesandbox.io/s/react-responsive-navbar-l2fcg",
      },
      {
        title: "React Todo List",
        link: "https://codesandbox.io/s/react-todo-list-j9fri",
      },
      {
        title: "Svelte Accordion Collapse",
        link: "https://codesandbox.io/s/svelte-accordion-collapse-vhc3m",
      },
      {
        title: "Svelte Modal and Sidebar",
        link: "https://codesandbox.io/s/svelte-modal-and-sidebar-7dijk",
      },
    ];

    /* src\sections\Snippets.svelte generated by Svelte v3.20.0 */
    const file$3 = "src\\sections\\Snippets.svelte";
    ...
    // (17:8) {#each javascriptSnippets as snippet, i}
    function create_each_block_1(ctx) {
    	let a;
    	let t0_value = /*snippet*/ ctx[0].title + "";
    	let t0;
    	let t1;
    	let a_href_value;
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(a, "href", a_href_value = /*snippet*/ ctx[0].link);
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "class", "flex flex-row text-white sm:w-1/2 py-4 px-6 bg-gray-900\r\n            hover:bg-yellow-400 hover:text-black transitions-colors duration-500\r\n            ease-in-put my-2 mx-4");
    			add_location(a, file$3, 17, 10, 589);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			append_dev(a, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(17:8) {#each javascriptSnippets as snippet, i}",
    		ctx
    	});
    ...
    // (31:8) {#each goSnippets as snippet, i}
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$3, 31, 10, 1060);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			append_dev(a, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(31:8) {#each goSnippets as snippet, i}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	let t6;
    	let div4;
    	let each_value_1 = javascriptSnippets;
    	...
    	const block = {
    		c: function create() {
    			section = element("section");
    			div0 = element("div");
    			div0.textContent = "Code Snippets";
    			t1 = space();
    			div6 = element("div");
    			div5 = element("div");
    			div1 = element("div");
    			div1.textContent = "Javascript";
    			t3 = space();
    			div2 = element("div");
    			...
    			attr_dev(div0, "class", "flex flex-col items-center justify-center text-white text-6xl\r\n    font-hairline tracking-wider mt-8");
    			add_location(div0, file$3, 5, 2, 113);
    			attr_dev(div1, "class", "text-white text-4xl font-hairline");
    			add_location(div1, file$3, 14, 6, 438);
    			attr_dev(div2, "class", "mb-8");
    			add_location(div2, file$3, 15, 6, 509);
    			attr_dev(div3, "class", "text-white text-4xl font-hairline");
    			add_location(div3, file$3, 28, 6, 934);
    			add_location(div4, file$3, 29, 6, 1001);
    			attr_dev(div5, "class", "flex flex-col max-w-screen-xl border p-4 w-full h-full mb-8");
    			add_location(div5, file$3, 12, 4, 355);
    			attr_dev(div6, "class", "flex justify-center");
    			add_location(div6, file$3, 11, 2, 316);
    			add_location(section, file$3, 4, 0, 100);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*javascriptSnippets*/ 0) {
    				each_value_1 = javascriptSnippets;
    				validate_each_argument(each_value_1);
    				let i;
    			...
    			if (dirty & /*goSnippets*/ 0) {
    				each_value = goSnippets;
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Snippets> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("Snippets", $$slots, []);
    	$$self.$capture_state = () => ({ javascriptSnippets, goSnippets });
    	return [];
    }
    ...
    /* src\components\Skill.svelte generated by Svelte v3.20.0 */
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			img = element("img");
    			attr_dev(div0, "class", "text-white font-hairline text-2xl mb-2 text-center");
    			add_location(div0, file$4, 12, 2, 319);
    			attr_dev(img, "class", img_class_value = `h-16 transition-transform duration-300 ease-in-out transform ${/*hover*/ ctx[1] ? "scale-110" : ""}`);
    			if (img.src !== (img_src_value = /*skill*/ ctx[0].icon)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$4, 16, 4, 467);
    			...
    			attr_dev(a, "class", "w-40 min-w-40 m-4 border rounded shadow p-4 bg-dark-gray-700\r\n  transitions-colors duration-300 ease-in-out hover:bg-dark-gray-600");
    			add_location(a, file$4, 6, 0, 68);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor, remount) {
    			...
    			dispose = [
    				listen_dev(a, "mouseenter", /*mouseenter_handler*/ ctx[2], false, false, false),
    				listen_dev(a, "mouseleave", /*mouseleave_handler*/ ctx[3], false, false, false)
    			];
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*skill*/ 1 && t0_value !== (t0_value = /*skill*/ ctx[0].name + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*hover*/ 2 && img_class_value !== (img_class_value = `h-16 transition-transform duration-300 ease-in-out transform ${/*hover*/ ctx[1] ? "scale-110" : ""}`)) {
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ skill, hover });
    	...
    	return [skill, hover, mouseenter_handler, mouseleave_handler];
    }

    class Skill extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { skill: 0 });
    ...
    /* src\sections\Skills.svelte generated by Svelte v3.20.0 */
    const file$5 = "src\\sections\\Skills.svelte";
    ...
    function create_each_block$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(40:4) {#each skills as skill}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(hr, "class", "w-64 text-white mb-4");
    			add_location(hr, file$5, 35, 4, 650);
    			attr_dev(div0, "class", "flex flex-col items-center justify-center text-white text-6xl\r\n    font-hairline tracking-wider");
    			add_location(div0, file$5, 31, 2, 518);
    			attr_dev(div1, "class", "flex flex-wrap items-center justify-center max-w-screen-xl mx-auto");
    			add_location(div1, file$5, 37, 2, 699);
    			add_location(section, file$5, 29, 0, 503);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ tech, Skill, skills, list });
    ...
    function create_fragment$7(ctx) {
    	...
    	const snippets = new Snippets({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$6, 9, 0, 292);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, t3);
    			mount_component(snippets, main, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
